...
// Kelvin it maps onto is a property of the bulbs being matched, not of the
// capability — these are Hue's range. They are the calibration knob: a lamp
// that reads colder than the ceiling at the warm end wants WARM_K lowered,
// not the formula below changed.
const COOL_K = 6500;
const WARM_K = 2200;
